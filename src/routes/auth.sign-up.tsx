...
export const meta: MetaFunction = () => {
  return buildPageMeta({ title: "Sign Up" })
}
...
const SignUp: React.FC = () => {
  return (
    <SimpleLayout
      illustration={
        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 889.076 459.38">
          ...
          />
          <circle cx={335.076} cy={150.38} r={9} fill="#ffa94d" />
          <circle cx={113.076} cy={250.38} r={9} fill="#ffa94d" />
          <circle cx={291.076} cy={450.38} r={9} fill="#ffa94d" />
          <circle cx={517.076} cy={177.38} r={9} fill="#ffa94d" />
          <circle cx={782.076} cy={442.38} r={9} fill="#ffa94d" />
          <circle cx={791.076} cy={206.38} r={9} fill="#ffa94d" />
          <circle cx={677.076} cy={368.38} r={9} fill="#ffa94d" />
        </svg>
      }
      title="Welcome to Dynapic"
      subtitle="Enter your name and email to create an account"
      footer={
        <Text color="grey">
          Already have an account?{" "}
          <Text variant="link" component={Link} to={routes.auth.signIn()}>
            Sign In
          </Text>
        </Text>
      }
    >
      ...
      >
        <TextInput required size="md" type="text" label="Name" placeholder="Your Name" />
        <TextInput
          required
          size="md"
          type="email"
